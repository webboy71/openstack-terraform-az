...
resource "null_resource" "ubuntu_openstack_provisioner" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      ...
      "sudo /home/azureuser/makestack.sh ${data.cloudflare_zero_trust_tunnel_cloudflared_token.ubuntu_tunnel_token.token} ${azurerm_linux_virtual_machine.openstack_ubuntu.public_ip_address}",
